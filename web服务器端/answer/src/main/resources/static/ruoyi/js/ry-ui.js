    ...
    $.extend({
        ...
        operate: {
            ...
            detail: function(id,width,height) {
            	...
            	$.modal.openDetail($.table._option.modalName+"详情", url,width,height);
            },
            // 修改信息
            editByName: function(id,width,height) {
            	var url = $.table._option.updateUrl.replace("{id}", id);
            	$.modal.open($.table._option.modalName, url,width,height);
            },
            // 添加信息 全屏
            addFull: function(id) {
            	var url = $.common.isEmpty(id) ? $.table._option.createUrl : $.table._option.createUrl.replace("{id}", id);
